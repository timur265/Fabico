            ...
            <div class="col-md-3">
                <div class="block block-themed">
                    ...
                    <div class="block-content block-content-full text-center bg-info-lighter">
                        <img class="img-avatar img-avatar96 img-avatar-thumb" src="{{ $category->getImage() }}" alt="">
                ...
                <div class="js-wizard-simple block">
                    ...
                    <div class="block-content block-content-full tab-content" style="min-height: 267px;">
                        ...
                        <div class="tab-pane active" id="wizard-simple2-step1" role="tabpanel">
                            ...
                            <div class="form-group">
                                <div class="form-material">
                                    <textarea class="form-control" id="ru_description" name="ru_description">{{ $category->ru_description }}</textarea>
                        ...
                        <div class="tab-pane" id="wizard-simple2-step2" role="tabpanel">
                            ...
                            <div class="form-group">
                                <div class="form-material">
                                    <textarea class="form-control" id="en_description" name="en_description">{{ $category->en_description }}</textarea>
                        ...
                        <div class="tab-pane" id="wizard-simple2-step3" role="tabpanel">
                            ...
                            <div class="form-group">
                                <div class="form-material">
                                    <textarea class="form-control" id="uz_description" name="uz_description">{{ $category->uz_description }}</textarea>
                        ...
                        <div class="form-material floating">
                            <select class="form-control" id="material-select2" name="parent_id">
                                ...
                                @foreach($categories as $category_list)
                                    <option value="{{ $category_list->id }}" @if($category_list->id == $category->parent_id) selected @endif>{{ $category_list->ru_title }}</option>
                                    @if($category_list->hasChildren())
                                        @include('admin.pages.categories.components.categories', ['dilimiter' => '---'])
                                    @endif
                                @endforeach
                            </select>
