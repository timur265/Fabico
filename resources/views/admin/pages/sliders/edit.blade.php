                        ...
                        <div class="tab-pane active" id="wizard-simple2-step1" role="tabpanel">
                            ...
                            <div class="form-group">
                                <div class="form-material floating">
                                    <input class="form-control" type="text" id="ru_title" name="ru_title" value="{{ $slider->ru_title }}">
                            ...
                            <div class="form-group">
                                <div class="form-material floating">
                                    <input class="form-control" type="text" id="link_video" name="link_video" value="{{ $slider->link_video }}">
                            ...
                            <div class="form-group">
                                <div class="form-material floating">
                                    <input class="form-control" type="text" id="link_page" name="link_page" value="{{ $slider->link_page }}">
                            ...
                            <div class="form-group">
                                <div class="form-material">
                                    <textarea class="form-control" id="ru_description" name="ru_description">{{ $slider->ru_description }}</textarea>
