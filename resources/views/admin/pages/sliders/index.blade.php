    ...
    <div class="row">
        <div class="col-md-12"><div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Слайдеры</h3>
                        ...
                        @foreach($sliders as $slider)
                            <tr>
                                <td width="50" class="text-center d-none d-md-none d-lg-table-cell">
                                    <img class="img-avatar img-avatar48" src="{{ $slider->getImage() }}" alt="">
                                </td>
                                <td class="font-w600">{{ $slider->ru_title}}</td>
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="{{ route('sliders.edit', [$slider->id, 'list_id' => intval($i/10)]) }}" class="btn btn-sm btn-secondary js-tooltip-enabled" data-toggle="tooltip" title="" data-original-title="Edit">
